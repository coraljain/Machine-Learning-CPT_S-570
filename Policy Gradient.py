...
class PolicyNet(nn.Module):
    def __init__(self):
        ...
        #first fully connected layer takes in 4 inputs (cart position, cart velocity, pole angle, pole velocity at tip)
        self.fc1 = nn.Linear(4, 24)
        self.fc2 = nn.Linear(24, 36)
        self.fc3 = nn.Linear(36, 2)  # Outputing value is Prob of Left
